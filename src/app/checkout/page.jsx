...
const Checkout = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    // console.log(selectedProducts.join(','));
...
calculateTotal();
 ...
 (
  ...
  <div className="flex flex-col gap-6 md:gap-0 md:flex-row min-h-screen md:justify-evenly">
    ...
    <button type="submit" className="bg-purple-400 shadow-md shadow-purple-500 text-white m-8 p-2 rounded-xl font-medium">Proceed to checkout</button>
  ...
  // <h2>tera selectedpRdocuts mar gaya</h2>
}
