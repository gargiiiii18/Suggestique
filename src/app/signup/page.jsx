...
const page = () => {
  ...
  return (
    <section className='mx-auto mb-20 pb-30 min-h-screen'>
      <h1 className='p-8 text-4xl md:text-5xl text-purple-600 text-center font-artistic font-semibold'>Signup</h1>

      <form className='mx-auto w-fit px-6 flex flex-col justify-around gap-4' onSubmit={handleSubmit} method='POST' action="">
        <Toaster/>
          ...
          <h2 className='text-left text-md md:text-lg text-purple-700 font-semibold'>Address Details</h2>
         
           <div className='flex w-100 justify-between items-center gap-14'>
             <label className='text-left md:text-lg text-sm'>Building, Area, Street</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
             <label className='text-left md:text-lg text-sm'>City</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
             <label className='text-left md:text-lg text-sm'>State</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
             <label className='text-left md:text-lg text-sm'>Country</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
            <label className='text-left md:text-lg text-sm'>Zipcode</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
            <label className='text-left md:text-lg text-sm text-purple-700 font-semibold'>Password</label>
          ...
          <div className='flex w-100 justify-between items-center gap-14'>
            <label className='text-left md:text-lg text-sm text-purple-700 font-semibold'>Confirm Password</label>
        ...
        <button type='submit' className='mx-auto w-24 md:w-40 mt-4 rounded-full text-white md:text-lg text-sm bg-purple-500 shadow-sm shadow-purple-900 py-1 md:px-6 md:py-2 md:w-50'>Sign Up</button>
      </form>
       <h3 className="text-center md:text-lg text-sm text-gray-500 font-semibold p-6">Already have an account? <Link className="text-purple-700" href='/signin'> Signin</Link></h3>
    </section>
  )
}
